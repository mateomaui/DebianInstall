...
# to edit:
# sudo nano debian-install-2-nvidia-add-i386-reboots.sh

# to make executable, run this in terminal after you save it
# sudo chmod +x debian-install-2-nvidia-add-i386-reboots.sh

# then to run:
# ./debian-install-2-nvidia-add-i386-reboots.sh
